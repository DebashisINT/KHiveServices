package com.breezefieldsaleskhive.features.logoutsync.presentation
...
import com.breezefieldsaleskhive.CustomConstants


import com.breezefieldsaleskhive.R
import com.breezefieldsaleskhive.app.AppDatabase
...
import com.breezefieldsaleskhive.app.utils.AppUtils
import com.breezefieldsaleskhive.app.utils.Toaster
import com.breezefieldsaleskhive.base.BaseResponse
import com.breezefieldsaleskhive.base.presentation.BaseActivity
import com.breezefieldsaleskhive.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsaleskhive.features.billing.api.AddBillingRepoProvider
import com.breezefieldsaleskhive.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsaleskhive.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsaleskhive.features.document.model.AddEditDocumentInputParams
import com.breezefieldsaleskhive.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsaleskhive.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsaleskhive.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsaleskhive.features.orderhistory.model.*
...
import com.breezefieldsaleskhive.features.quotation.model.AddQuotInputModel
import com.breezefieldsaleskhive.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsaleskhive.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsaleskhive.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldsaleskhive.features.stock.api.StockRepositoryProvider
import com.breezefieldsaleskhive.features.stock.model.AddStockInputParamsModel
import com.breezefieldsaleskhive.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsaleskhive.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsaleskhive.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldsaleskhive.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsaleskhive.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsaleskhive.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsaleskhive.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsaleskhive.mappackage.SendBrod
import com.breezefieldsaleskhive.widgets.AppCustomTextView
import com.breezefieldsaleskhive.MonitorService
import com.breezefieldsaleskhive.MySingleton
import com.breezefieldsaleskhive.app.AlarmReceiver
...
import com.breezefieldsaleskhive.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsaleskhive.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsaleskhive.features.login.model.GetConcurrentUserResponse
import com.breezefieldsaleskhive.features.login.model.WhatsappApiData
import com.breezefieldsaleskhive.features.orderITC.SyncDeleteOppt
import com.breezefieldsaleskhive.features.orderITC.SyncDeleteOpptL
import com.breezefieldsaleskhive.features.orderITC.SyncEditOppt
import com.breezefieldsaleskhive.features.orderITC.SyncOppt
import com.breezefieldsaleskhive.features.orderITC.SyncOpptProductL
import com.breezefieldsaleskhive.features.orderITC.SyncOrd
import com.breezefieldsaleskhive.features.orderITC.SyncOrdProductL
import com.breezefieldsaleskhive.features.performance.model.Gps_status_list
import com.breezefieldsaleskhive.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsaleskhive.features.returnsOrder.ReturnProductList
import com.breezefieldsaleskhive.features.returnsOrder.ReturnRequest
import com.breezefieldsaleskhive.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleskhivelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleskhivelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleskhivelogsample/log.zip").path);
